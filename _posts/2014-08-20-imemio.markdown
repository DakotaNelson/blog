...
{:.center}
![search]({{site.url}}/assets/ferguson_search.png)
...
{:.center}
![overview]({{site.url}}/assets/ferguson_overview.png)
...
{:.center}
![overview]({{site.url}}/assets/PropagandaAttempt.png)
